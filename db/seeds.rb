...
#   Character.create(name: 'Luke', movie: movies.first)
 ...
 User.destroy_all
 kermit = User.create!(email: 'kermit@TheMuppetShow.com', first_name: 'Kermit', last_name: 'The Frog', password:'asdf123', birth_date: Faker::Date.between(to: 50.years.ago, from: Date.today))
