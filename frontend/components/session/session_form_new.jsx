...
class SessionForm extends React.Component {
  constructor(props){
    ...
    this._hasErrors_ = this._hasErrors_.bind(this);
  ...
  // errorShow(){
  //   if (!this._hasErrors_()) return null;
  //   return (
        ...
        <div className='login-container'>
          <form className='login-form'> 
           {/* {this.errorShow()} */}
            ...
            />
            <label>
               Password (Session Form.jsx)
            </label>
            <input type="text" 
                   onChange = {this.handleInput('password')}
                  //  value = {this.state.email}
            />
            <button className='loginButton' onClick={this._handleSubmit_} > Log in  </button>
          </form>
        </div>
     )
  }
